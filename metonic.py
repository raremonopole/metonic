...
def metonic_cycle_calc(sync_error, planetary_year, moon_period):
    ...
    for _ in range(100):
        ...
        if error < sync_error: 
            ...
            #       Metonic cycle meeting error specification of less than {sync_error} days found. 
            #       It has length {approx_planet_years} in planetary years and {approx_moon_months} in 'moon' months. """)
